...
parse_params <- function(filepath) {
  ...
  for (line in lines) {
    if (grepl("^--", line)) {
      ...
      # Convert logical strings to actual logical values
...
if (!exists("TEST") || is.null(TEST)) {
  ...
  # Testing mode
  report_params <- parse_params("/blue/cancercenter-dept/PIPELINES/REPORTING/rmarkdown_report_module/param_files/Sharma_params.txt")
}
